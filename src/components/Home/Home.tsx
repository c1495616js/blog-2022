    ...
    <div className="mx-auto flex h-full max-w-7xl flex-col items-center justify-center gap-1  p-8 lg:flex-row lg:gap-10">
      <div className="w-full lg:w-1/2">
        <div className="mb-0 lg:mb-20">
          <p className="text-lg text-primary2 dark:text-white">Hi all. I am</p>
      ...
      <div className="hidden flex-col  gap-2 text-white-faded lg:flex lg:w-1/2">
        ...
        <p>
          ...
          user-friendly interfaces that provide the best possible experience for
          users. I am confident in my ability to create scalable, maintainable,
          and efficient applications, and I am excited to contribute my skills
